...
})({"gTIEU":[function(require,module,exports,__globalThis) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SERVER_PORT = 59296;
...
const createImage = (url, alt)=>{
    ...
    if (!url || typeof url === "object" && Object.keys(url).length === 0) img.src = new URL(require("8e2e60a42e57052c")).href;
    else if (typeof url === "string") img.src = url;
    else if (url.default) img.src = url.default;
    img.alt = alt;
    return img;
};
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","8e2e60a42e57052c":"11gjO"}],"11gjO":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("homePage.32863026.png") + "?" + Date.now();

},{}],"kLojj":[function(require,module,exports,__globalThis) {
//TODO
//Note: You will not be able to run parcel without first fixing these errors
...
},{"../images/homePage.png":"4K0cp","./utilityRenderFunctions.js":"guzyD","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"4K0cp":[function() {},{}]},["gTIEU","a0t4e"], "a0t4e", "parcelRequire8016", {}, "./", "/")
